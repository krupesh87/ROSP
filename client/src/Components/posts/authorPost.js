...
import { authorPosts } from '../../Services/api'
...
const AuthorPost = (props) => {
    ...
    const fetchData = async () => {
        let data = await authorPosts({ "author": params.author });
        setposts(data)
    }
    ...
    return (
        <>
            <Banner /> <br />
            <Typography variant="h4" className={classes.heading}>{params.category} Posts By {params.author}</Typography> <br /><br />
            <Grid container>
                {
